...
const api: BurrowAPI = {
  ...
  getAppDetails: (appId) => ipcRenderer.invoke('burrow:app-details', appId),
  revealApp: (appId) => ipcRenderer.invoke('burrow:app-reveal', appId),
  uninstallApp: (reviewId) => ipcRenderer.invoke('burrow:app-uninstall', reviewId),
